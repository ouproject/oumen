      ...
      <div>
        ...
        <div class="places">
          <p class="placesp1">
            ...
            <span class="spanpl2">{{$store.state.schedulingData[0].start_addr}}</span>
          </p>
          <p class="placesp1">
            <span class="spanpl1">目的地：</span>
            <span class="spanpl2">{{$store.state.schedulingData[0].end_addr}}</span>
          </p>
        </div>
        <div>
          <div class="clnum">
...
<script>
    export default {
      ...
      mounted(){
          console.log('-----------------op',this.$store.state.goodsData.sendDatas)
      ...
      methods:{
        ...
        payall(){
          ...
          console.log('vvvvvvvvvvvvvvvv',this.$store.state.orderSate)
          var params = new URLSearchParams();
          params.append('reg_tel', this.$store.state.loginTel);
          params.append('money', this.pricesall);
          params.append('user_name',this.$store.state.familys.personum);
